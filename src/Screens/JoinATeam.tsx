...
import { findTeams } from "../functions/functions";
  ...
  return (
    <div>
      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        <button
          onClick={async () => {
            if (!skills.length && !sdgsSelected.length) {
              return message.warning("Select one or more skills or SDGs.");
            }
            setLoading(true);
            setEntries([]);
            await findTeams(skills)
              .finally(() => {
                setLoading(false);
              })
              .then((result) => {
